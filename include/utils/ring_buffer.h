...
#define BLAZE_CACHE_ALIGNED alignas(blaze::kCacheLineSize)
...
private:
    ...
    BLAZE_CACHE_ALIGNED std::atomic<uint64_t> head_;
    BLAZE_CACHE_ALIGNED uint64_t tail_cached_ = 0;
    BLAZE_CACHE_ALIGNED std::atomic<uint64_t> tail_;
    BLAZE_CACHE_ALIGNED uint64_t head_cached_ = 0;
    BLAZE_CACHE_ALIGNED T storage_[Capacity];
};
...
private:
    ...
    BLAZE_CACHE_ALIGNED std::atomic<uint64_t> tail_;
    BLAZE_CACHE_ALIGNED T storage_[Capacity];
    BLAZE_CACHE_ALIGNED std::atomic<bool> committed_[Capacity] = {};
};
